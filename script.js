...
let vocabForReading = [
    ...
    { word: "ban", ipa: "/bæn/", type: "verb/noun", example: "The city decided to ban smoking in public places.", meaning: "cấm", exampleMeaning: "Thành phố quyết định cấm hút thuốc ở nơi công cộng." },
    { word: "bear", ipa: "/ber/", type: "verb", example: "She couldn’t bear the pain anymore.", meaning: "chịu đựng", exampleMeaning: "Cô ấy không thể chịu đựng cơn đau thêm nữa." },
    { word: "center", ipa: "/ˈsen.t̬ɚ/", type: "noun", example: "The community center hosts many events.", meaning: "trung tâm", exampleMeaning: "Trung tâm cộng đồng tổ chức nhiều sự kiện." },
    { word: "concentrate on", ipa: "/ˈkɑːn.sən.treɪt ɑːn/", type: "phrase", example: "He needs to concentrate on his studies.", meaning: "tập trung vào", exampleMeaning: "Anh ấy cần tập trung vào việc học." },
    { word: "encounter", ipa: "/ɪnˈkaʊn.t̬ɚ/", type: "verb/noun", example: "They encountered a problem during the trip.", meaning: "gặp phải", exampleMeaning: "Họ đã gặp phải một vấn đề trong chuyến đi." },
    { word: "disease", ipa: "/dɪˈziːz/", type: "noun", example: "The disease spread quickly in the village.", meaning: "bệnh tật", exampleMeaning: "Căn bệnh lây lan nhanh chóng trong làng." },
    { word: "repair", ipa: "/rɪˈper/", type: "verb", example: "He repaired the broken chair.", meaning: "sửa chữa", exampleMeaning: "Anh ấy đã sửa chiếc ghế bị hỏng." },
    { word: "impair", ipa: "/ɪmˈper/", type: "verb", example: "Loud noise can impair your hearing.", meaning: "làm suy yếu", exampleMeaning: "Tiếng ồn lớn có thể làm suy yếu thính giác của bạn." },
    { word: "rapid", ipa: "/ˈræp.ɪd/", type: "adjective", example: "The rapid growth of the city surprised everyone.", meaning: "nhanh chóng", exampleMeaning: "Sự phát triển nhanh chóng của thành phố khiến mọi người ngạc nhiên." },
    { word: "urban", ipa: "/ˈɝː.bən/", type: "adjective", example: "Urban areas often face traffic problems.", meaning: "đô thị", exampleMeaning: "Các khu vực đô thị thường gặp vấn đề giao thông." },
    { word: "visible", ipa: "/ˈvɪz.ə.bəl/", type: "adjective", example: "The stars are visible on a clear night.", meaning: "nhìn thấy được", exampleMeaning: "Các ngôi sao có thể nhìn thấy vào một đêm trời quang." },
    { word: "objective", ipa: "/əbˈdʒek.tɪv/", type: "noun/adjective", example: "Her objective is to finish the project on time.", meaning: "mục tiêu", exampleMeaning: "Mục tiêu của cô ấy là hoàn thành dự án đúng hạn." },
    { word: "subjective", ipa: "/səbˈdʒek.tɪv/", type: "adjective", example: "The review was very subjective.", meaning: "chủ quan", exampleMeaning: "Bài đánh giá rất chủ quan." },
    { word: "objection", ipa: "/əbˈdʒek.ʃən/", type: "noun", example: "He raised an objection to the plan.", meaning: "sự phản đối", exampleMeaning: "Anh ấy đã đưa ra sự phản đối với kế hoạch." },
    { word: "prospective", ipa: "/prəˈspek.tɪv/", type: "adjective", example: "They met with prospective clients.", meaning: "tiềm năng", exampleMeaning: "Họ đã gặp gỡ các khách hàng tiềm năng." },
    { word: "diet", ipa: "/ˈdaɪ.ət/", type: "noun", example: "She follows a healthy diet.", meaning: "chế độ ăn uống", exampleMeaning: "Cô ấy tuân theo một chế độ ăn uống lành mạnh." },
    { word: "advantage", ipa: "/ədˈvæn.t̬ɪdʒ/", type: "noun", example: "Having experience is an advantage in this job.", meaning: "lợi thế", exampleMeaning: "Có kinh nghiệm là một lợi thế trong công việc này." },
    { word: "disadvantage", ipa: "/ˌdɪs.ədˈvæn.t̬ɪdʒ/", type: "noun", example: "The disadvantage of living here is the noise.", meaning: "bất lợi", exampleMeaning: "Bất lợi của việc sống ở đây là tiếng ồn." },
    { word: "create", ipa: "/kriˈeɪt/", type: "verb", example: "She created a beautiful painting.", meaning: "tạo ra", exampleMeaning: "Cô ấy đã tạo ra một bức tranh đẹp." },
    { word: "creativity", ipa: "/ˌkri.eɪˈtɪv.ə.t̬i/", type: "noun", example: "The project requires a lot of creativity.", meaning: "sự sáng tạo", exampleMeaning: "Dự án đòi hỏi rất nhiều sự sáng tạo." },
    { word: "abundant", ipa: "/əˈbʌn.dənt/", type: "adjective", example: "The region has abundant natural resources.", meaning: "dồi dào", exampleMeaning: "Khu vực này có nguồn tài nguyên thiên nhiên dồi dào." },
    { word: "press", ipa: "/pres/", type: "verb", example: "Press the button to start the machine.", meaning: "ấn, ép", exampleMeaning: "Ấn nút để khởi động máy." },
    { word: "pressure", ipa: "/ˈpreʃ.ɚ/", type: "noun", example: "She felt pressure to finish the work on time.", meaning: "áp lực", exampleMeaning: "Cô ấy cảm thấy áp lực phải hoàn thành công việc đúng hạn." },
    { word: "stimulate", ipa: "/ˈstɪm.jə.leɪt/", type: "verb", example: "The program aims to stimulate economic growth.", meaning: "kích thích", exampleMeaning: "Chương trình nhằm kích thích tăng trưởng kinh tế." },
    { word: "satisfy", ipa: "/ˈsæt̬.ɪs.faɪ/", type: "verb", example: "The meal didn’t satisfy his hunger.", meaning: "làm hài lòng", exampleMeaning: "Bữa ăn không làm hài lòng cơn đói của anh ấy." },
    { word: "restore", ipa: "/rɪˈstɔːr/", type: "verb", example: "They restored the old house to its original state.", meaning: "khôi phục", exampleMeaning: "Họ đã khôi phục ngôi nhà cũ về trạng thái ban đầu." },
    { word: "predict", ipa: "/prɪˈdɪkt/", type: "verb", example: "Experts predict a rise in temperatures.", meaning: "dự đoán", exampleMeaning: "Các chuyên gia dự đoán nhiệt độ sẽ tăng." },
    { word: "actual", ipa: "/ˈæk.tʃu.əl/", type: "adjective", example: "The actual cost was higher than expected.", meaning: "thực tế", exampleMeaning: "Chi phí thực tế cao hơn dự kiến." },
    { word: "actually", ipa: "/ˈæk.tʃu.əl.i/", type: "adverb", example: "I actually enjoyed the movie.", meaning: "thực sự", exampleMeaning: "Tôi thực sự thích bộ phim." },
    { word: "seriously", ipa: "/ˈsɪr.i.əs.li/", type: "adverb", example: "You need to take this seriously.", meaning: "nghiêm túc", exampleMeaning: "Bạn cần nghiêm túc với việc này." },
    { word: "possible", ipa: "/ˈpɑː.sə.bəl/", type: "adjective", example: "It’s possible to finish the task today.", meaning: "có thể", exampleMeaning: "Có thể hoàn thành nhiệm vụ hôm nay." },
    { word: "impossible", ipa: "/ɪmˈpɑː.sə.bəl/", type: "adjective", example: "It’s impossible to predict the weather accurately.", meaning: "không thể", exampleMeaning: "Không thể dự đoán thời tiết chính xác." },
    { word: "slightly", ipa: "/ˈslaɪt.li/", type: "adverb", example: "The room is slightly bigger than the other one.", meaning: "hơi", exampleMeaning: "Căn phòng hơi lớn hơn căn kia." },
    { word: "somewhat", ipa: "/ˈsʌm.wʌt/", type: "adverb", example: "The test was somewhat difficult.", meaning: "phần nào", exampleMeaning: "Bài kiểm tra phần nào khó." },
    { word: "gently", ipa: "/ˈdʒent.li/", type: "adverb", example: "She gently closed the door.", meaning: "nhẹ nhàng", exampleMeaning: "Cô ấy nhẹ nhàng đóng cửa." },
    { word: "overwhelming", ipa: "/ˌoʊ.vɚˈwel.mɪŋ/", type: "adjective", example: "The support was overwhelming.", meaning: "quá sức", exampleMeaning: "Sự ủng hộ thật quá sức." },
    { word: "license", ipa: "/ˈlaɪ.səns/", type: "noun", example: "He got his driver’s license last week.", meaning: "giấy phép", exampleMeaning: "Anh ấy đã nhận được giấy phép lái xe tuần trước." },
    { word: "at least", ipa: "/æt liːst/", type: "phrase", example: "You should rest for at least an hour.", meaning: "ít nhất", exampleMeaning: "Bạn nên nghỉ ngơi ít nhất một giờ." },
    { word: "income", ipa: "/ˈɪn.kʌm/", type: "noun", example: "Her income increased this year.", meaning: "thu nhập", exampleMeaning: "Thu nhập của cô ấy tăng lên trong năm nay." },
    { word: "outcome", ipa: "/ˈaʊt.kʌm/", type: "noun", example: "The outcome of the meeting was positive.", meaning: "kết quả", exampleMeaning: "Kết quả của cuộc họp rất tích cực." },
    { word: "invoice", ipa: "/ˈɪn.vɔɪs/", type: "noun", example: "The company sent an invoice for the services.", meaning: "hóa đơn", exampleMeaning: "Công ty đã gửi hóa đơn cho các dịch vụ." },
    { word: "customer", ipa: "/ˈkʌs.tə.mɚ/", type: "noun", example: "The customer was happy with the product.", meaning: "khách hàng", exampleMeaning: "Khách hàng hài lòng với sản phẩm." },
    { word: "customize", ipa: "/ˈkʌs.tə.maɪz/", type: "verb", example: "You can customize your phone’s settings.", meaning: "tùy chỉnh", exampleMeaning: "Bạn có thể tùy chỉnh cài đặt điện thoại của mình." },
    { word: "accustomed to", ipa: "/əˈkʌs.təmd tuː/", type: "phrase", example: "She is accustomed to waking up early.", meaning: "quen với", exampleMeaning: "Cô ấy quen với việc thức dậy sớm." },
    { word: "period", ipa: "/ˈpɪr.i.əd/", type: "noun", example: "The project will take a period of three months.", meaning: "khoảng thời gian", exampleMeaning: "Dự án sẽ kéo dài trong khoảng thời gian ba tháng." },
    { word: "achieve", ipa: "/əˈtʃiːv/", type: "verb", example: "He achieved his goal of running a marathon.", meaning: "đạt được", exampleMeaning: "Anh ấy đã đạt được mục tiêu chạy marathon." },
    { word: "achievement", ipa: "/əˈtʃiːv.mənt/", type: "noun", example: "Winning the award was a great achievement.", meaning: "thành tựu", exampleMeaning: "Việc giành được giải thưởng là một thành tựu lớn." },
    { word: "service", ipa: "/ˈsɝː.vɪs/", type: "noun", example: "The restaurant provides excellent service.", meaning: "dịch vụ", exampleMeaning: "Nhà hàng cung cấp dịch vụ tuyệt vời." },
    { word: "reserve", ipa: "/rɪˈzɝːv/", type: "verb/noun", example: "We reserved a table at the restaurant.", meaning: "dự trữ", exampleMeaning: "Chúng tôi đã đặt trước một bàn tại nhà hàng." },
    { word: "deserve", ipa: "/dɪˈzɝːv/", type: "verb", example: "You deserve a break after working so hard.", meaning: "xứng đáng", exampleMeaning: "Bạn xứng đáng được nghỉ ngơi sau khi làm việc chăm chỉ." },
    { word: "succeed in", ipa: "/səkˈsiːd ɪn/", type: "phrase", example: "She succeeded in passing the exam.", meaning: "thành công trong", exampleMeaning: "Cô ấy đã thành công trong việc vượt qua kỳ thi." },
    { word: "succession", ipa: "/səkˈseʃ.ən/", type: "noun", example: "The team won three games in succession.", meaning: "sự kế tiếp", exampleMeaning: "Đội đã thắng ba trận liên tiếp." },
    { word: "fiction", ipa: "/ˈfɪk.ʃən/", type: "noun", example: "She enjoys reading fiction novels.", meaning: "hư cấu", exampleMeaning: "Cô ấy thích đọc tiểu thuyết hư cấu." },
    { word: "contrary", ipa: "/ˈkɑːn.tre.ri/", type: "adjective", example: "The results were contrary to our expectations.", meaning: "trái ngược", exampleMeaning: "Kết quả trái ngược với kỳ vọng của chúng tôi." },
    { word: "on the contrary", ipa: "/ɑːn ðə ˈkɑːn.tre.ri/", type: "phrase", example: "He isn’t tired; on the contrary, he’s full of energy.", meaning: "ngược lại", exampleMeaning: "Anh ấy không mệt; ngược lại, anh ấy tràn đầy năng lượng." },

    { word: "ruin", ipa: "/ˈruː.ɪn/", type: "verb/noun", example: "The storm will ruin the crops.", meaning: "lụi tàn", exampleMeaning: "Cơn bão sẽ làm lụi tàn mùa màng." },
    { word: "sincerely", ipa: "/sɪnˈsɪr.li/", type: "adverb", example: "She sincerely apologized for her mistake.", meaning: "chân thành", exampleMeaning: "Cô ấy đã chân thành xin lỗi vì lỗi lầm của mình." },
    { word: "duplicate", ipa: "/ˈduː.plə.keɪt/", type: "verb", example: "Please duplicate this document for me.", meaning: "nhân đôi", exampleMeaning: "Vui lòng nhân đôi tài liệu này cho tôi." },
    { word: "beverage", ipa: "/ˈbev.ɚ.ɪdʒ/", type: "noun", example: "They served a variety of beverages at the party.", meaning: "đồ uống", exampleMeaning: "Họ đã phục vụ nhiều loại đồ uống tại bữa tiệc." },
    { word: "occupy", ipa: "/ˈɑː.kjə.paɪ/", type: "verb", example: "The army will occupy the city.", meaning: "chiếm đóng", exampleMeaning: "Quân đội sẽ chiếm đóng thành phố." },
    { word: "occupation", ipa: "/ˌɑː.kjəˈpeɪ.ʃən/", type: "noun", example: "Her occupation is a doctor.", meaning: "sự chiếm đóng", exampleMeaning: "Nghề nghiệp của cô ấy là bác sĩ." },
    { word: "productivity", ipa: "/ˌproʊ.dəkˈtɪv.ə.t̬i/", type: "noun", example: "The new system increased productivity.", meaning: "năng suất", exampleMeaning: "Hệ thống mới đã tăng năng suất." },
    { word: "performance", ipa: "/pɚˈfɔːr.məns/", type: "noun", example: "His performance in the play was amazing.", meaning: "hiệu suất", exampleMeaning: "Hiệu suất của anh ấy trong vở kịch thật tuyệt vời." },
    { word: "fare", ipa: "/fer/", type: "noun", example: "The bus fare increased this month.", meaning: "tiền vé", exampleMeaning: "Tiền vé xe buýt đã tăng trong tháng này." },
    { word: "airfare", ipa: "/ˈer.fer/", type: "noun", example: "The airfare to Paris is quite expensive.", meaning: "tiền vé máy bay", exampleMeaning: "Tiền vé máy bay đến Paris khá đắt." },
    { word: "comprehensive", ipa: "/ˌkɑːm.prəˈhen.sɪv/", type: "adjective", example: "The report provides a comprehensive overview.", meaning: "toàn bộ", exampleMeaning: "Báo cáo cung cấp một cái nhìn toàn bộ." },
    { word: "interrupt", ipa: "/ˌɪn.t̬əˈrʌpt/", type: "verb", example: "Please don’t interrupt while I’m speaking.", meaning: "gián đoạn", exampleMeaning: "Vui lòng đừng gián đoạn khi tôi đang nói." },
    { word: "disruption", ipa: "/dɪsˈrʌp.ʃən/", type: "noun", example: "The storm caused a major disruption.", meaning: "sự gián đoạn", exampleMeaning: "Cơn bão đã gây ra một sự gián đoạn lớn." },
    { word: "lucrative", ipa: "/ˈluː.krə.t̬ɪv/", type: "adjective", example: "The deal was very lucrative for the company.", meaning: "sinh lời", exampleMeaning: "Thỏa thuận rất sinh lời cho công ty." },
    { word: "stipulate", ipa: "/ˈstɪp.jə.leɪt/", type: "verb", example: "The contract stipulates a deadline.", meaning: "quy định", exampleMeaning: "Hợp đồng quy định một thời hạn." },
    { word: "career", ipa: "/kəˈrɪr/", type: "noun", example: "She has a successful career in law.", meaning: "nghề nghiệp", exampleMeaning: "Cô ấy có một sự nghiệp thành công trong ngành luật." },
    { word: "patient", ipa: "/ˈpeɪ.ʃəns/", type: "noun", example: "The doctor saw a patient this morning.", meaning: "bệnh nhân", exampleMeaning: "Bác sĩ đã gặp một bệnh nhân sáng nay." },
    { word: "motivate", ipa: "/ˈmoʊ.t̬ə.veɪt/", type: "verb", example: "The coach motivated the team to win.", meaning: "khuyến khích", exampleMeaning: "Huấn luyện viên đã khuyến khích đội giành chiến thắng." },
    { word: "deposit", ipa: "/dɪˈpɑː.zɪt/", type: "verb", example: "She deposited money into her account.", meaning: "gửi tiền", exampleMeaning: "Cô ấy đã gửi tiền vào tài khoản của mình." },
    { word: "stable", ipa: "/ˈsteɪ.bəl/", type: "adjective", example: "The economy is now stable.", meaning: "ổn định", exampleMeaning: "Nền kinh tế hiện nay ổn định." },
    { word: "fluctuation", ipa: "/ˈflʌk.tʃu.eɪt/", type: "noun", example: "There was a fluctuation in the stock market.", meaning: "biến động", exampleMeaning: "Có một sự biến động trên thị trường chứng khoán." },
    { word: "bankrupt", ipa: "/ˈbæŋ.krʌpt/", type: "adjective", example: "The company went bankrupt last year.", meaning: "phá sản", exampleMeaning: "Công ty đã phá sản vào năm ngoái." },
    { word: "collapse", ipa: "/kəˈlæps/", type: "verb", example: "The building collapsed during the earthquake.", meaning: "sụp đổ", exampleMeaning: "Tòa nhà đã sụp đổ trong trận động đất." },
    { word: "substantial", ipa: "/səbˈstæn.ʃəl/", type: "adjective", example: "They made a substantial profit this year.", meaning: "to lớn", exampleMeaning: "Họ đã kiếm được lợi nhuận to lớn trong năm nay." },
    { word: "flexible", ipa: "/ˈflek.sə.bəl/", type: "adjective", example: "The schedule is flexible for everyone.", meaning: "linh hoạt", exampleMeaning: "Lịch trình linh hoạt cho mọi người." },
    { word: "diversify", ipa: "/dɪˈvɝː.sə.faɪ/", type: "verb", example: "The company plans to diversify its products.", meaning: "phong phú", exampleMeaning: "Công ty dự định làm phong phú sản phẩm của mình." },
    { word: "fore", ipa: "/fɔːr/", type: "adjective", example: "The issue came to the fore during the meeting.", meaning: "trước", exampleMeaning: "Vấn đề được đưa ra trước trong cuộc họp." },
    { word: "forecast", ipa: "/ˈfɔːr.kæst/", type: "verb/noun", example: "The weather forecast predicts rain.", meaning: "dự đoán", exampleMeaning: "Dự báo thời tiết dự đoán có mưa." },
    { word: "broadcast", ipa: "/ˈbrɑːd.kæst/", type: "verb/noun", example: "The news was broadcast on TV.", meaning: "phát sóng", exampleMeaning: "Tin tức được phát sóng trên TV." },
    { word: "downsize", ipa: "/ˈdaʊn.saɪz/", type: "verb", example: "The company had to downsize its staff.", meaning: "thu nhỏ", exampleMeaning: "Công ty phải thu nhỏ đội ngũ nhân viên." },
    { word: "diminish", ipa: "/dɪˈmɪn.ɪʃ/", type: "verb", example: "The resources will diminish over time.", meaning: "thu nhỏ", exampleMeaning: "Tài nguyên sẽ thu nhỏ theo thời gian." },
    { word: "bilingual", ipa: "/baɪˈlɪŋ.ɡwəl/", type: "adjective", example: "She is bilingual in English and Spanish.", meaning: "song ngữ", exampleMeaning: "Cô ấy song ngữ tiếng Anh và tiếng Tây Ban Nha." },
    { word: "amend", ipa: "/əˈmend/", type: "verb", example: "They will amend the contract terms.", meaning: "điều chỉnh", exampleMeaning: "Họ sẽ điều chỉnh các điều khoản hợp đồng." },
    { word: "amendment", ipa: "/əˈmend.mənt/", type: "noun", example: "The amendment was approved by the board.", meaning: "sự điều chỉnh", exampleMeaning: "Sự điều chỉnh đã được hội đồng phê duyệt." },
    { word: "amenity", ipa: "/əˈmen.ə.t̬i/", type: "noun", example: "The hotel offers many amenities.", meaning: "sự tiện nghi", exampleMeaning: "Khách sạn cung cấp nhiều tiện nghi." },
    { word: "modify", ipa: "/ˈmɑː.də.faɪ/", type: "verb", example: "You can modify the settings on your phone.", meaning: "điều chỉnh", exampleMeaning: "Bạn có thể điều chỉnh cài đặt trên điện thoại của mình." },
    { word: "evident", ipa: "/ˈev.ə.dənt/", type: "adjective", example: "Her happiness was evident to everyone.", meaning: "rõ ràng", exampleMeaning: "Niềm vui của cô ấy rõ ràng với mọi người." },
    { word: "evidence", ipa: "/ˈev.ə.dəns/", type: "noun", example: "The police found evidence at the scene.", meaning: "bằng chứng", exampleMeaning: "Cảnh sát đã tìm thấy bằng chứng tại hiện trường." },
    { word: "profile", ipa: "/ˈproʊ.faɪl/", type: "noun", example: "She created a profile on the website.", meaning: "tiểu sử", exampleMeaning: "Cô ấy đã tạo một tiểu sử trên trang web." },
    { word: "fascinating", ipa: "/ˈfæs.ən.eɪt/", type: "adjective", example: "The documentary was fascinating.", meaning: "thu hút", exampleMeaning: "Bộ phim tài liệu rất thu hút." },
    { word: "obtain", ipa: "/əbˈteɪn/", type: "verb", example: "He obtained a degree in engineering.", meaning: "đạt được", exampleMeaning: "Anh ấy đã đạt được bằng kỹ sư." },
    { word: "consult", ipa: "/kənˈsʌlt/", type: "verb", example: "You should consult a doctor about your symptoms.", meaning: "tham vấn", exampleMeaning: "Bạn nên tham vấn bác sĩ về triệu chứng của mình." },
    { word: "consultant", ipa: "/kənˈsʌl.tənt/", type: "noun", example: "The consultant gave us great advice.", meaning: "người tham vấn", exampleMeaning: "Người tham vấn đã cho chúng tôi lời khuyên tuyệt vời." },
    { word: "consultation", ipa: "/ˌkɑːn.sʌlˈteɪ.ʃən/", type: "noun", example: "The consultation with the lawyer was helpful.", meaning: "sự tham vấn", exampleMeaning: "Buổi tham vấn với luật sư rất hữu ích." },
    { word: "skyscraper", ipa: "/ˈskaɪˌskreɪ.pɚ/", type: "noun", example: "The city is famous for its skyscrapers.", meaning: "nhà chọc trời", exampleMeaning: "Thành phố nổi tiếng với những tòa nhà chọc trời." },
    { word: "transportation", ipa: "/ˌtræn.spɚˈteɪ.ʃən/", type: "noun", example: "Public transportation is very convenient here.", meaning: "phương tiện giao thông", exampleMeaning: "Phương tiện giao thông công cộng ở đây rất tiện lợi." },
    { word: "depart", ipa: "/dɪˈpɑːrt/", type: "verb", example: "The train will depart at 8 AM.", meaning: "khởi hành", exampleMeaning: "Tàu sẽ khởi hành lúc 8 giờ sáng." },
    { word: "departure", ipa: "/dɪˈpɑːr.tʃɚ/", type: "noun", example: "The departure time is 9 PM.", meaning: "điểm xuất phát", exampleMeaning: "Thời gian khởi hành là 9 giờ tối." },
    { word: "correspond", ipa: "/ˌkɔːr.əˈspɑːnd/", type: "verb", example: "The results correspond with our expectations.", meaning: "thích hợp", exampleMeaning: "Kết quả thích hợp với kỳ vọng của chúng tôi." },
    { word: "rejoice", ipa: "/rɪˈdʒɔɪs/", type: "verb", example: "They rejoiced at the news of her recovery.", meaning: "hân hoan", exampleMeaning: "Họ hân hoan trước tin tức về sự hồi phục của cô ấy." },
    { word: "enjoy", ipa: "/ɪnˈdʒɔɪ/", type: "verb", example: "We enjoy spending time together.", meaning: "tận hưởng", exampleMeaning: "Chúng tôi tận hưởng thời gian bên nhau." },
    { word: "enjoyable", ipa: "/ɪnˈdʒɔɪ.ə.bəl/", type: "adjective", example: "The trip was very enjoyable.", meaning: "thích thú", exampleMeaning: "Chuyến đi rất thích thú." },
    { word: "launch", ipa: "/lɑːntʃ/", type: "verb", example: "They will launch a new product next month.", meaning: "tung", exampleMeaning: "Họ sẽ tung ra một sản phẩm mới vào tháng tới." },
    { word: "original", ipa: "/əˈrɪdʒ.ən.əl/", type: "adjective", example: "This is the original version of the book.", meaning: "nguyên bản", exampleMeaning: "Đây là phiên bản nguyên bản của cuốn sách." }
].filter((item, index, self) =>
        index === self.findIndex((t) => t.word.toLowerCase() === item.word.toLowerCase())
    );
